...
def plot_event(num, events, metadata, smearing = [10], peak_width = 2, sigma_cut = 2, produce_plot = True, output = False):
    u = units()
    ...
    if produce_plot:
        ...
        full = [(peak_timeP[i], peaksP[i][1]) for i in range(2) if peaksP[i][1] > 5]
        dashed = [(peak_timeP[i], peaksP[i][1]) for i in range(2) if peaksP[i][1] > 3 and peaksP[i][1] <= 5]
        dotted = [(peak_timeP[i], peaksP[i][1]) for i in range(2) if peaksP[i][1] > 1 and peaksP[i][1] <= 3]
        if len(full) > 0:
        ...
        full = [(peak_timeS[i], peaksS[i][1]) for i in range(2) if peaksS[i][1] > 5]
        dashed = [(peak_timeS[i], peaksS[i][1]) for i in range(2) if peaksS[i][1] > 3 and peaksS[i][1] <= 5]
        dotted = [(peak_timeS[i], peaksS[i][1]) for i in range(2) if peaksS[i][1] > 1 and peaksS[i][1] <= 3]
# =============================================================================
...
# =============================================================================
        ...
        if output:
            fname = 'sample_9_point_' + str(num) + '.pdf'
            plt.savefig(fname)
